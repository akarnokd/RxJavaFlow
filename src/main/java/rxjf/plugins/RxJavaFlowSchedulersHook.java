 ...
 * 2.  You may wrap/decorate an {@link Runnable}, before it is handed off to a Scheduler.  The system-
 ...
 */
public class RxJavaFlowSchedulersHook {

    protected RxJavaFlowSchedulersHook() {

    }

    private final static RxJavaFlowSchedulersHook DEFAULT_INSTANCE = new RxJavaFlowSchedulersHook();
     ...
     */
    public Runnable onSchedule(Runnable action) {
        return action;
    }

    public static RxJavaFlowSchedulersHook getDefaultInstance() {
