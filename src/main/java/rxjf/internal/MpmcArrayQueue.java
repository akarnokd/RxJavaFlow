...
abstract class MpmcArrayQueueProducerField<E> extends MpmcArrayQueueL1Pad<E> {
    private final static long P_INDEX_OFFSET = addressOf(MpmcArrayQueueProducerField.class, "producerIndex");
...
abstract class MpmcArrayQueueConsumerField<E> extends MpmcArrayQueueL2Pad<E> {
    private final static long C_INDEX_OFFSET = addressOf(MpmcArrayQueueConsumerField.class, "consumerIndex");
