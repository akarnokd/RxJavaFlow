...
public final class BlockingOperatorLatest {
    ...
    /**
     * Returns an {@code Iterable} that blocks until or unless the {@code Flowable} emits an item that has not
     * been returned by the {@code Iterable}, then returns that item
     *
     * @param source
     *            the source {@code Flowable}
     * @return an {@code Iterable} that blocks until or unless the {@code Flowable} emits an item that has not
     *         been returned by the {@code Iterable}, then returns that item
     */
    public static <T> Iterable<T> latest(final Flowable<? extends T> source) {
    ...
    static final class LatestObserverIterator<T> extends AbstractDisposableSubscriber<Notification<? extends T>> implements Iterator<T> {
