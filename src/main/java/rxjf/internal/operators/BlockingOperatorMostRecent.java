...
/**
 * Returns an Iterable that always returns the item most recently emitted by an Flowable, or a
...
public final class BlockingOperatorMostRecent {
    ...
    /**
     * Returns an {@code Iterable} that always returns the item most recently emitted by the {@code Flowable}.
     *
     * @param source
     ...
     */
    public static <T> Iterable<T> mostRecent(final Flowable<? extends T> source, final T initialValue) {
        return new Iterable<T>() {
            @Override
            public Iterator<T> iterator() {
                MostRecentSubscriber<T> mostRecentObserver = new MostRecentSubscriber<>(initialValue);

                /**
                 * Subscribe instead of unsafeSubscribe since this is the final subscribe in the chain
                 * since it is for BlockingFlowable.
                 */
    ...
    private static final class MostRecentSubscriber<T> extends AbstractSubscriber<T> {
        final NotificationLite<T> nl = NotificationLite.instance();
        volatile Object value;
        
        private MostRecentSubscriber(T value) {
