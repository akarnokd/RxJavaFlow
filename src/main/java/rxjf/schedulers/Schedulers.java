...
public final class Schedulers {
    ...
    private Schedulers() {
        Scheduler c = RxJavaFlowPlugins.getInstance().getSchedulersHook().getComputationScheduler();
        if (c != null) {
        ...
        Scheduler io = RxJavaFlowPlugins.getInstance().getSchedulersHook().getIOScheduler();
        if (io != null) {
            ioScheduler = io;
        } else {
        ...
        Scheduler nt = RxJavaFlowPlugins.getInstance().getSchedulersHook().getNewThreadScheduler();
        if (nt != null) {
