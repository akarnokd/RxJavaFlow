...
public final class OperatorOnErrorResumeNextViaFunction<T> implements Operator<T, T> {
    ...
    private final Function<Throwable, ? extends Observable<? extends T>> resumeFunction;

    public OperatorOnErrorResumeNextViaFunction(Function<Throwable, ? extends Observable<? extends T>> f) {
