...
public final class OnSubscribeDelaySubscriptionWithSelector<T, U> implements OnSubscribe<T> {
    ...
    final Supplier<? extends Observable<U>> subscriptionDelay;

    public OnSubscribeDelaySubscriptionWithSelector(Observable<? extends T> source, Supplier<? extends Observable<U>> subscriptionDelay) {
        this.source = source;
