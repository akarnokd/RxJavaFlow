...
public final class OnSubscribeUsing<T, Resource> implements OnSubscribe<T> {
    ...
    private final Function<? super Resource, ? extends Observable<? extends T>> observableFactory;
    private final Action1<? super Resource> dispose;
    private final boolean disposeEagerly;

    public OnSubscribeUsing(Supplier<Resource> resourceFactory,
            Function<? super Resource, ? extends Observable<? extends T>> observableFactory,
