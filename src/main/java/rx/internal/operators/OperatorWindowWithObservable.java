...
public final class OperatorWindowWithObservable<T, U> implements Operator<Observable<T>, T> {
    final Supplier<? extends Observable<? extends U>> otherFactory;

    public OperatorWindowWithObservable(Supplier<? extends Observable<? extends U>> otherFactory) {
        this.otherFactory = otherFactory;
    }
    public OperatorWindowWithObservable(final Observable<U> other) {
        this.otherFactory = new Supplier<Observable<U>>() {
