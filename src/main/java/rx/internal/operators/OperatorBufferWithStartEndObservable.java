...
public final class OperatorBufferWithStartEndObservable<T, TOpening, TClosing> implements Operator<List<T>, T> {
    ...
    final Function<? super TOpening, ? extends Observable<? extends TClosing>> bufferClosing;
     ...
     *            a {@link Function} object which produces {@link Observable}s. These {@link Observable}s determine
     *            when a buffer is emitted and replaced by simply producing an object.
     */
    public OperatorBufferWithStartEndObservable(Observable<? extends TOpening> bufferOpenings, Function<? super TOpening, ? extends Observable<? extends TClosing>> bufferClosingSelector) {
