 ...
 * {@link Observable} constructed using the {@link Supplier} argument, produces a value. The buffer is then
...
public final class OperatorBufferWithSingleObservable<T, TClosing> implements Operator<List<T>, T> {
    final Supplier<? extends Observable<? extends TClosing>> bufferClosingSelector;
    final int initialCapacity;
    /**
     * @param bufferClosingSelector
     *            a {@link Supplier} object which produces {@link Observable}s. These {@link Observable}s determine
     ...
     */
    public OperatorBufferWithSingleObservable(Supplier<? extends Observable<? extends TClosing>> bufferClosingSelector,
            int initialCapacity) {
    ...
    public OperatorBufferWithSingleObservable(final Observable<? extends TClosing> bufferClosing,
            int initialCapacity) {
        this.bufferClosingSelector = new Supplier<Observable<? extends TClosing>>() {
            @Override
