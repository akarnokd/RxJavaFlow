...
import rx.internal.subscriptions.ScalarSubscription;
...
public final class ScalarSynchronousObservable<T> extends Observable<T> {
    final T value;
    private ScalarSynchronousObservable(OnSubscribe<T> onSubscribe, T value) {
        super(onSubscribe);
        this.value = value;
    }
    
    public static <T> ScalarSynchronousObservable<T> create(T value) {
        return new ScalarSynchronousObservable<>(s -> s.onSubscribe(new ScalarSubscription<>(s, value)), value);
    }
