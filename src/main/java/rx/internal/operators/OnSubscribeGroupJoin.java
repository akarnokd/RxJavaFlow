...
public final class OnSubscribeGroupJoin<T1, T2, D1, D2, R> implements OnSubscribe<R> {
    ...
    protected final Function<? super T1, ? extends Observable<D1>> leftDuration;
    protected final Function<? super T2, ? extends Observable<D2>> rightDuration;
    protected final BiFunction<? super T1, ? super Observable<T2>, ? extends R> resultSelector;

    public OnSubscribeGroupJoin(
            Observable<T1> left,
            Observable<T2> right,
            Function<? super T1, ? extends Observable<D1>> leftDuration,
            Function<? super T2, ? extends Observable<D2>> rightDuration,
            BiFunction<? super T1, ? super Observable<T2>, ? extends R> resultSelector) {
        this.left = left;
        this.right = right;
