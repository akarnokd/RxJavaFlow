...
public final class OperatorOnErrorFlatMap<T> implements Operator<T, T> {
    ...
    private final Function<OnErrorThrowable, ? extends Observable<? extends T>> resumeFunction;

    public OperatorOnErrorFlatMap(Function<OnErrorThrowable, ? extends Observable<? extends T>> f) {
