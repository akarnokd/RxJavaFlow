...
public final class BlockingObservable<T> {
    ...
    public T firstOrDefault(T defaultValue) {
        return blockForSingle(((Observable<T>)o).firstOrDefault(defaultValue));
    }
    ...
    public T firstOrDefault(T defaultValue, Predicate<? super T> predicate) {
        return blockForSingle(((Observable<T>)o.filter(predicate)).firstOrDefault(defaultValue));
    }
    ...
    public T lastOrDefault(T defaultValue) {
        return blockForSingle(((Observable<T>)o).lastOrDefault(defaultValue));
    }
    ...
    public T lastOrDefault(T defaultValue, Predicate<? super T> predicate) {
        return blockForSingle(((Observable<T>)o.filter(predicate)).lastOrDefault(defaultValue));
    }
    ...
    public T singleOrDefault(T defaultValue) {
        return blockForSingle(((Observable<T>)o).singleOrDefault(defaultValue));
    }
    ...
    public T singleOrDefault(T defaultValue, Predicate<? super T> predicate) {
        return blockForSingle(((Observable<T>)o).filter(predicate).singleOrDefault(defaultValue));
    }
