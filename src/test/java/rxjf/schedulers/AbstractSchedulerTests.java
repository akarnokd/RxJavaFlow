...
public abstract class AbstractSchedulerTests {
    ...
    public final void testNestedScheduling() {
        ...
        Flowable<Integer> ids = Flowable.from(Arrays.asList(1, 2)).subscribeOn(getScheduler());

        Flowable<String> m = ids.flatMap(id -> Flowable.from(Arrays.asList("a-" + id, "b-" + id)).subscribeOn(getScheduler())
                .map(s -> "names=>" + s));
    ...
    @Test
    public final void testRecursiveSchedulerInFlowable() {
    ...
    public final void testObserveOn() throws InterruptedException {
        ...
        Flowable<String> o = Flowable.just("one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten");
    ...
    public final void testSubscribeOnNestedConcurrency() throws InterruptedException {
        ...
        Flowable<String> o = Flowable.from("one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten")
                .flatMap(new Function<String, Flowable<String>>() {

                    @Override
                    public Flowable<String> call(final String v) {
