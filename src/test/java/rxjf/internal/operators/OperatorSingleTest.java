...
public class OperatorSingleTest {
    ...
    public void testSingleWithTooManyElements() {
        Flowable<Integer> observable = Flowable.from(1, 2).single();
    ...
    public void testSingleWithPredicateAndTooManyElements() {
        Flowable<Integer> observable = Flowable.from(1, 2, 3, 4).single(
                t1 -> t1 % 2 == 0);
    ...
    public void testSingleOrDefault() {
        Flowable<Integer> observable = Flowable.just(1).singleOrDefault(2);
    ...
    public void testSingleOrDefaultWithTooManyElements() {
        Flowable<Integer> observable = Flowable.from(1, 2).singleOrDefault(
                3);
    ...
    public void testSingleOrDefaultWithPredicateAndTooManyElements() {
        Flowable<Integer> observable = Flowable.from(1, 2, 3, 4)
    ...
    public void testIssue1527() throws InterruptedException {
        ...
        Flowable<Integer> source = Flowable.from(1, 2, 3, 4, 5, 6);
        Flowable<Integer> reduced = source.reduce((i1, i2) -> i1 + i2);
