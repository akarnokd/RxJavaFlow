...
public class OperatorBufferTest {
    ...
    public void bufferWithTimeTake1() {
        Flowable<Long> source = Flowable.timer(40, 40, TimeUnit.MILLISECONDS, scheduler);
    ...
    public void bufferWithBoundaryTake2() {
        Flowable<Long> boundary = Flowable.timer(60, 60, TimeUnit.MILLISECONDS, scheduler);
        Flowable<Long> source = Flowable.timer(40, 40, TimeUnit.MILLISECONDS, scheduler);
    ...
    public void bufferWithStartEndBoundaryTake2() {
        Flowable<Long> start = Flowable.timer(61, 61, TimeUnit.MILLISECONDS, scheduler);
        Function<Long, Flowable<Long>> end = new Function<Long, Flowable<Long>>() {
            @Override
            public Flowable<Long> call(Long t1) {
                return Flowable.timer(100, 100, TimeUnit.MILLISECONDS, scheduler);
            }
        };
    ...
    public void bufferWithTimeAndSize() {
        Flowable<Long> source = Flowable.timer(30, 30, TimeUnit.MILLISECONDS, scheduler);
    ...
    public void testProducerRequestThroughBufferWithSize1() {
        ...
        Flowable.create(new Flowable.OnSubscribe<Integer>() {
