...
public class BackpressureTests {
    ...
    public void testFlatMapSync() {
        ...
        AtomicInteger c = new AtomicInteger();
        TestSubscriber<Integer> ts = new TestSubscriber<Integer>();
        incrementingIntegers(c).flatMap(new Function<Integer, Observable<Integer>>() {
    ...
    public void testFlatMapAsync() {
        ...
        AtomicInteger c = new AtomicInteger();
        TestSubscriber<Integer> ts = new TestSubscriber<Integer>();
        incrementingIntegers(c).subscribeOn(Schedulers.computation()).flatMap(new Function<Integer, Observable<Integer>>() {
