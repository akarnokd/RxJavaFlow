...
public class OnSubscribeIterableTest {
    ...
    public void empty() {
        ...
        Observable<Integer> source = Observable.from(Arrays.asList());
    ...
    public void testListIterable() {
        Observable<String> observable = Observable.from(Arrays.asList("one", "two", "three"));
    ...
    public void testRawIterable() {
        ...
        Observable<String> observable = Observable.from(it);
    ...
    public void testNoBackpressure() {
        Observable<Integer> o = Observable.from(Arrays.asList(1, 2, 3, 4, 5));
        TestSubscriber<Integer> ts = new TestSubscriber<>(0);
        o.subscribe(ts);
        ts.assertNoValues();
    ...
    public void testSubscribeMultipleTimes() {
        Observable<Integer> o = Observable.from(Arrays.asList(1, 2, 3));
        for (int i = 0; i < 4; i++) {
            TestSubscriber<Integer> ts = new TestSubscriber<>();
            o.subscribe(ts);
