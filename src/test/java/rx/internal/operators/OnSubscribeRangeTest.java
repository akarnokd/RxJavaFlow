...
public class OnSubscribeRangeTest {
    ...
    public void takeSome() {
        ...
        Observable<Integer> source = Observable.range(1, 5).take(2);
    ...
    public void testRangeStartAt2Count3() {
        ...
        Observable.range(2, 3).subscribe(ts);
    ...
    public void testBackpressureViaRequest() {
        Observable<Integer> o = Observable.range(1, Flow.defaultBufferSize());
        TestSubscriber<Integer> ts = new TestSubscriber<>(0);
    ...
    public void testRequestOverflow() {
        final AtomicInteger count = new AtomicInteger();
        int n = 10;
        Observable.range(1, n).subscribe(new AbstractSubscriber<Integer>() {
